    ...
    <div className="manager-dashboard">
      <div className="container-fluid px-4">
        ...
        {activeTab === 'documents' && (
          <div className="card">
            <div className="card-header d-flex justify-content-between align-items-center">
              <h5 className="card-title mb-0">Pending Document Approvals</h5>
              ...
              {pendingDocuments.length > 0 ? (
                      ...
                      <div className="card h-100 border-warning">
                        <div className="card-body">
                          ...
                          <div className="student-info mb-3">
                            <p className="mb-1">
                              <strong>Student:</strong> {document.student_name}
                            </p>
                          ...
                          <div className="document-actions d-grid gap-2">
                            {document.file_url && (
                              <a
                            ...
                            <div className="btn-group btn-group-sm">
                              <button 
                                onClick={() => handleQuickAcceptDocument(document.id)}
                                className="btn btn-success"
                              ...
                              <button 
                                onClick={() => handleQuickRefuseDocument(document)}
                                className="btn btn-danger"
                ...
                <div className="text-center py-5">
                  ...
                  <p className="text-muted">
                    Great job! There are no pending documents that need your review.
                  </p>
                </div>
              )}
            </div>
